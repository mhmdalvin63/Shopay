                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-start data mb-2 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 text-start"><h4>{{ $siswa->id }}</h4></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 text-start data mb-2 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">:</div>
                                    <div class="col-md-5 text-start"><h4>{{ $siswa->nisn }}</h4></div>
                                </div>
                            </div>
                            <hr class="bg-danger border-2 border-top border-danger">
                            <div class="col-md-12 text-start data mb-2 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">:</div>
                                    <div class="col-md-5 text-start"><h4>{{ $siswa->nis }}</h4></div>
                                </div>
                            </div>
                            <hr class="bg-danger border-2 border-top border-danger">
                            <div class="col-md-12 text-start data mb-2 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">:</div>
                                    <div class="col-md-5 text-start"><h4>{{ $siswa->nama }}</h4></div>
                                </div>
                            </div>
                            <hr class="bg-danger border-2 border-top border-danger">
                            <div class="col-md-12 text-start data mb-2 text-center">
                            ...
                            <div class="col-md-12 text-start data mb-2 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">:</div>
                                    <div class="col-md-5 text-start"><h4>{{ $siswa->alamat }}</h4></div>
                                </div>
                            </div>
                            <hr class="bg-danger border-2 border-top border-danger">
                            <div class="col-md-12 text-start data mb-2 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">:</div>
                                    <div class="col-md-5 text-start"><h4>{{ $siswa->no_telp }}</h4></div>
                                </div>
                            </div>
                            <hr class="bg-danger border-2 border-top border-danger">
                            <div class="col-md-12 text-start data mb-2 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">:</div>
                                    <div class="col-md-5 text-start"><h4>{{ $siswa->spps->tahun }}</h4></div>
                                </div>
                            </div>
                            <hr class="bg-danger border-2 border-top border-danger">
                            <div class="col-md-12 text-start data mb-2 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">:</div>
                                    <div class="col-md-5 text-start"><h4>Rp. {{number_format($siswa->spps->nominal, 0,",",".")}}</h4></div>
                                </div>
                            </div>
                        </div>
                        <a href="{{ route('siswa_index') }}" class="btn btn-outline-warning btn-icon-text mt-4">                                                  
                            Kembali
                        </a>
                    </form>
                </div>
